# coding=utf-8
from corefgraph.resources.lambdas import equality_checker, list_checker, fail, matcher
...
_wh_pronoun = "PRO~RE"
# in TUT there are distinct tags for relative and interrogative pronouns. Here only relative pro are given
_wh_possessive_pronoun = fail
_wh_determiner = fail
_wh_adverb = fail
_verbs_list = (
    "VAU~CG", "VAU~CO", "VAU~FU", "VAU~IM", "VAU~IN", "VAU~PA", "VAU~RA", "VAU~RE", "VMA~CG", "VMA~CO", "VMA~FU", "VMA~GE",
    "VMA~IM", "VMA~IN", "VMA~IP", "VMA~PA", "VMA~PE", "VMA~RA", "VMA~RE", "VMO~CG", "VMO~CO", "VMO~FU", "VMO~GE", "VMO~IM",
    "VMO~IN", "VMO~PA", "VMO~RA", "VMO~RE")
_modal = fail
...
# Adjectives
adjective = list_checker((_adjective, _adjective_comparative, _adjective_superlative))
